            ...
            <div className="flex gap-8">
                <div className="lg:w-3/5 flex flex-col gap-8">
                    ...
                    <p className="text-gray-500 font-medium">
                        ...
                        voluptas, quae, quidem, fugiat quas quos quibusdam voluptates
                        doloribus ipsam doloremque repellendus. Quaerat, laborum 
                        consequuntur
                    </p>
                </div>
            ...
            <div className="flex flex-col md:flex-row gap-12">
                  ...
                  <div className="lg:text-lg flex flex-col gap-6 text-justify">
                    <p>
                        ...
                        exercitationem aliquam maxime quaerat, enuim autem culpa sequi at!
                        Earum facere in ducimus culpa. Lorem ipsum dolor sit amet
                        consectetur, adipisicing elit. Libero fuga modi amet error aliquid
                        eos nobis vero soluta facilis, voluptatem, valuptates quod suscipit
                        obcaecati voluptate quaerat loborum, voluptatum dicta ipsum.
                    </p>
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias neque
                        fugiat itaque quas esse sunt cupiditate possimus cumque asperiores, 
