    ...
    return (
        <div className="mt-4 flex flex-col gap-4">
            ...
            <div className="">
                ...
                <p className="mt-8 text-md md:text-xl">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sequi rerum accusantium.</p>
            </div>
            {/* animated button */}
            {/* md:block -> block = Sets display: block (makes the element visible) */}
